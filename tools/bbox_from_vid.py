...
parser.add_argument("-c", "--center", help="select bounding box / ROI from center point", action='store_true')
    ...
    if args.vid is not None:
        ...
        while True:
            ...
            if _:
                ...
                # Tracking failure
                cv2.putText(frame, "Tracking failure detected", (100,80), cv.FONT_HERSHEY_SIMPLEX, 0.75,(0,0,255),2)
